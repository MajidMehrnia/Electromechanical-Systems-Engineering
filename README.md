# Electromechanical Systems Engineering: EV Powertrain & Thermal Co-Simulation
...
**Project Novelty:** Integrated co-simulation of mechanical systems (GT-SUITE) with electrical and control loops (Simulink).
